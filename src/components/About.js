...
function About() {
  return (
    ...
    <p class="text-navy-800 dark:text-gray-900  block font-sans font-normal leading-relaxed text-inherit antialiased dark:text-white  pt-8 lg:px-48">
...
<Link to = "/resume" className ="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold md:rounded-full my-6 py-4 md:px-8 px-10 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out lg:ml-80 ">
            view my profile
          </Link>
</div>
